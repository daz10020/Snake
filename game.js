...
var GluttonousSnake = function (id) {
  ...
  // 4 => 蛇尾
  // this.map_2017 = [
  //   [1, 0, [2, 't'], 0, 0, 0, 2, 3, 3, 0, [2, 't'], 0, 4, 0, 3, 3, [2, 'r']],
  //   [0, 0, 3, 0, 0, 0, [4, 'b'], 0, 3, 0, 3, 0, 3, 0, 3, 0],
  //   [0, 0, 3, 0, 0, 0, 3, 0, 3, 0, 3, 0, 3, 0, 3, 3, 3],
  //   [0, 0, 3, 0, 0, 0, 3, 0, 3, 0, 0, 3, 0, 0, 3, 0],
  //   [0, 0, 3, 3, 4, 0, 3, 3, 3, 0, 0, [3, 't'], 0, 0, 3, 3, 4]
  // ];
  this.map_2017 = [
    [1, 0, 0, 0, [2, 't'], 0, 3, 3, [2, 'r'], 0, [2, 't'], 0, 4],
    [0, 0, 0, 0, 3, 0, 3, 0, 0, 0, 3, 0, 3],
    [0, 0, 0, 0, 3, 0, 3, 3, 3,0,  3, 0, 3],
    [0, 0, [4, 't'], 0, 3, 0,0, 0, 3, 0, 0, 3],
    [0, 0, 0, 3, 0, 0, 3, 3, 3, 0, 0, [3, 't']]
  ];
  // 是否游戏中
  this.isInGame = false
  // 是否结束游戏
...
GluttonousSnake.prototype._gridFill = function (x, y, isColor, i) {
  var color_1 = i % 2 == 1 ? '#493531' : '#372c22'
  var color_2 = i % 2 != 1 ? '#493531' : '#372c22'
...
// 入场2017
GluttonousSnake.prototype._drawEntry_bb = function () {
  this.ctx.save()
